...
<div class="page-title">
    <div class="title_left">
        <h3>Lançamentos <small>Conta a receber</small></h3>
    </div>
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <form class="form-horizontal form-label-left" data-parsley-validate  method="post">
                    <input type="hidden" name="id" value="<?= $lancamento->data['id'] ?>" />
                    ...
                    <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="cliente_id">Fornecedor<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <select name="cliente_id" id="cliente_id" class="form-control">
                                <option value="">Selecione o fornecedor</option>
								<?php foreach ($clientes as $cliente): ?>
                                    <option value="<?= $cliente['id'] ?>" <?= $lancamento->cliente_id == $cliente['id'] ? 'selected="selected"' : '' ?>>
										<?= $cliente['nome'] ?>
                                    </option>
								<?php endforeach; ?>
                            </select>
